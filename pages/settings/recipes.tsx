...
// RecipeBuilderModal removed - now using dedicated page at /settings/recipes/new
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center space-x-3">
                <Button
                  onClick={() => router.push('/settings/recipes/history')}
                ...
                <Button
                  onClick={() => router.push('/settings/recipes/archived')}
                  className="bg-white/20 hover:bg-white/30 backdrop-blur-sm"
                >
                ...
                <Button
                  onClick={() => router.push('/settings/recipes/new')}
                  className="bg-white/20 hover:bg-white/30 backdrop-blur-sm"
                >
