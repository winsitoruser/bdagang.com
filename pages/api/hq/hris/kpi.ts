...
async function getKPIData(req: NextApiRequest, res: NextApiResponse) {
  ...
  // If no DB data, use enhanced mock
  if (employeeKPIs.length === 0) {
    employeeKPIs = generateMockEmployeeKPIs(currentPeriod);
    if (employeeId) employeeKPIs = employeeKPIs.filter(e => e.employeeId === employeeId);
  }
  if (branchKPIs.length === 0) {
    branchKPIs = generateMockBranchKPIs();
    if (branchId) branchKPIs = branchKPIs.filter(b => b.branchId === branchId);
  }
    ...
    try {
      ...
      for (const m of metrics) {
        const [result] = await sequelize.query(`
          ...
          VALUES (uuid_generate_v4(), :employeeId, :branchId, :period, :name, :category, :target, :actual, :unit, :weight, 'pending', :templateId)
...
function generateMockEmployeeKPIs(period: string) {
  return [
    {
      ...
      metrics: [
        { id: '1', name: 'Target Penjualan', category: 'sales', target: 1200000000, actual: 1250000000, unit: 'Rp', weight: 40, trend: 'up', period },
        { id: '2', name: 'Kepuasan Pelanggan', category: 'customer', target: 90, actual: 92, unit: '%', weight: 20, trend: 'up', period },
        { id: '3', name: 'Efisiensi Operasional', category: 'operations', target: 85, actual: 88, unit: '%', weight: 20, trend: 'stable', period },
        { id: '4', name: 'Kehadiran Tim', category: 'operations', target: 95, actual: 98, unit: '%', weight: 20, trend: 'up', period },
      ],
      status: 'exceeded', lastUpdated: new Date().toISOString()
    },
    {
      ...
      metrics: [
        { id: '5', name: 'Target Penjualan', category: 'sales', target: 900000000, actual: 920000000, unit: 'Rp', weight: 40, trend: 'up', period },
        { id: '6', name: 'Kepuasan Pelanggan', category: 'customer', target: 90, actual: 88, unit: '%', weight: 20, trend: 'down', period },
        { id: '7', name: 'Efisiensi Operasional', category: 'operations', target: 85, actual: 86, unit: '%', weight: 20, trend: 'stable', period },
        { id: '8', name: 'Kehadiran Tim', category: 'operations', target: 95, actual: 96, unit: '%', weight: 20, trend: 'up', period },
      ],
      status: 'exceeded', lastUpdated: new Date().toISOString()
    },
    {
      ...
      metrics: [
        { id: '9', name: 'Target Penjualan', category: 'sales', target: 850000000, actual: 780000000, unit: 'Rp', weight: 40, trend: 'down', period },
        { id: '10', name: 'Kepuasan Pelanggan', category: 'customer', target: 90, actual: 85, unit: '%', weight: 20, trend: 'down', period },
        { id: '11', name: 'Efisiensi Operasional', category: 'operations', target: 85, actual: 82, unit: '%', weight: 20, trend: 'down', period },
        { id: '12', name: 'Kehadiran Tim', category: 'operations', target: 95, actual: 94, unit: '%', weight: 20, trend: 'stable', period },
      ],
      status: 'partial', lastUpdated: new Date().toISOString()
    },
    {
      employeeId: '4', employeeName: 'Eko Prasetyo', position: 'Kasir Senior', branchName: 'Cabang Pusat Jakarta', department: 'Sales',
      overallScore: 90, overallAchievement: 110,
      metrics: [
        { id: '13', name: 'Transaksi Harian', category: 'sales', target: 50, actual: 58, unit: 'transaksi', weight: 30, trend: 'up', period },
        { id: '14', name: 'Nilai Transaksi', category: 'sales', target: 15000000, actual: 16500000, unit: 'Rp', weight: 30, trend: 'up', period },
        { id: '15', name: 'Upselling', category: 'sales', target: 10, actual: 12, unit: '%', weight: 20, trend: 'up', period },
        { id: '16', name: 'Akurasi Kasir', category: 'operations', target: 99, actual: 99.5, unit: '%', weight: 20, trend: 'stable', period },
      ],
      status: 'exceeded', lastUpdated: new Date().toISOString()
    },
  ];
...
function generateMockBranchKPIs() {
  return [
    { branchId: '1', branchName: 'Cabang Pusat Jakarta', branchCode: 'HQ-001', manager: 'Ahmad Wijaya', overallAchievement: 104, salesKPI: 104, operationsKPI: 103, customerKPI: 102, employeeCount: 25, topPerformers: 8, lowPerformers: 2, totalRevenue: 1250000000, transactionCount: 3200 },
    { branchId: '2', branchName: 'Cabang Bandung', branchCode: 'BR-002', manager: 'Siti Rahayu', overallAchievement: 102, salesKPI: 102, operationsKPI: 101, customerKPI: 98, employeeCount: 18, topPerformers: 5, lowPerformers: 3, totalRevenue: 920000000, transactionCount: 2400 },
    { branchId: '3', branchName: 'Cabang Surabaya', branchCode: 'BR-003', manager: 'Budi Santoso', overallAchievement: 92, salesKPI: 92, operationsKPI: 96, customerKPI: 94, employeeCount: 15, topPerformers: 3, lowPerformers: 4, totalRevenue: 780000000, transactionCount: 1800 },
    { branchId: '4', branchName: 'Cabang Medan', branchCode: 'BR-004', manager: 'Dedi Kurniawan', overallAchievement: 95, salesKPI: 94, operationsKPI: 97, customerKPI: 96, employeeCount: 12, topPerformers: 3, lowPerformers: 2, totalRevenue: 650000000, transactionCount: 1500 },
    { branchId: '5', branchName: 'Cabang Yogyakarta', branchCode: 'BR-005', manager: 'Rina Susanti', overallAchievement: 98, salesKPI: 97, operationsKPI: 99, customerKPI: 100, employeeCount: 10, topPerformers: 4, lowPerformers: 1, totalRevenue: 580000000, transactionCount: 1200 },
  ];
}
