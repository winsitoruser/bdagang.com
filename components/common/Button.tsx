...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    outline: 'border-2 border-gray-300 text-gray-700 hover:bg-gray-50 focus:ring-gray-500 disabled:border-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed'
  };
